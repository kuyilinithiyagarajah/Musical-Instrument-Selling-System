...
<head>
    <meta charset="UTF-8">
    <title>Create Financial Record</title>
...
<div class="container mx-auto max-w-lg bg-white p-8 rounded-xl shadow-lg">
    <h1 class="text-3xl font-bold mb-6 text-center text-gray-800">Create Financial Record</h1>
...
<script src="/js/financial_records/create.js"></script>
</body>
</html>
